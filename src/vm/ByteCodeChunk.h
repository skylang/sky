...
#ifndef vm_ByteCodeChunk_h
#define vm_ByteCodeChunk_h
...
namespace Sky {
    ...
    public:
        ForeignFunction(const std::string& name, TypeDeclaration* returnType, const std::vector<TypeDeclaration*>& argTypes): name(name), returnType(returnType), argTypes(argTypes) {}

        std::string name;
        TypeDeclaration* returnType;
        std::vector<TypeDeclaration*> argTypes;
    ...
    public:
        ...
        int addForeignFunction(FunctionDeclaration& n);
